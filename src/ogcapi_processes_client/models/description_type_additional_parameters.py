...
class DescriptionTypeAdditionalParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "role", "href", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "href": obj.get("href"),
            "parameters": [AdditionalParameter.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj
