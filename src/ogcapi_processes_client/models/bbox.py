...
class Bbox(BaseModel):
    ...
    crs: Optional[StrictStr] = 'http://www.opengis.net/def/crs/OGC/1.3/CRS84'
    ...
    def crs_validate_enum(cls, value):
        ...
        if value not in set(['http://www.opengis.net/def/crs/OGC/1.3/CRS84', 'http://www.opengis.net/def/crs/OGC/0/CRS84h']):
