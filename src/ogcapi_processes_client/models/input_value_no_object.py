...
INPUTVALUENOOBJECT_ONE_OF_SCHEMAS = ["Bbox", "List[str]", "bool", "bytearray", "float", "int", "str"]
...
class InputValueNoObject(BaseModel):
    ...
    actual_instance: Optional[Union[Bbox, List[str], bool, bytearray, float, int, str]] = None
    one_of_schemas: Set[str] = { "Bbox", "List[str]", "bool", "bytearray", "float", "int", "str" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = InputValueNoObject.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in InputValueNoObject with oneOf schemas: Bbox, List[str], bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in InputValueNoObject with oneOf schemas: Bbox, List[str], bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into InputValueNoObject with oneOf schemas: Bbox, List[str], bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into InputValueNoObject with oneOf schemas: Bbox, List[str], bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Bbox, List[str], bool, bytearray, float, int, str]]:
