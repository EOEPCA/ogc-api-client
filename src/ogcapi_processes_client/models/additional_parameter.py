...
class AdditionalParameter(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    value: List[AdditionalParameterValueInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "value": [AdditionalParameterValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
