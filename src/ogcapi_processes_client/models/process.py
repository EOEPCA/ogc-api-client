...
class Process(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "keywords", "metadata", "additionalParameters", "id", "version", "mutable", "jobControlOptions", "outputTransmission", "links", "inputs", "outputs"]
