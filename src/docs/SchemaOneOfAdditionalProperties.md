...
json = "{}"
# create an instance of SchemaOneOfAdditionalProperties from a JSON string
schema_one_of_additional_properties_instance = SchemaOneOfAdditionalProperties.from_json(json)
# print the JSON string representation of the object
print(SchemaOneOfAdditionalProperties.to_json())

# convert the object into a dict
schema_one_of_additional_properties_dict = schema_one_of_additional_properties_instance.to_dict()
# create an instance of SchemaOneOfAdditionalProperties from a dict
schema_one_of_additional_properties_from_dict = SchemaOneOfAdditionalProperties.from_dict(schema_one_of_additional_properties_dict)
```
