...
class QualifiedInputValue(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schema": FormatSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "value": InputValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
