...
class SchemaOneOf(BaseModel):
    ...
    multiple_of: Optional[Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]] = Field(default=None, alias="multipleOf")
    ...
    min_properties: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=0, alias="minProperties")
    ...
    var_not: Optional[SchemaOneOfNot] = Field(default=None, alias="not")
    all_of: Optional[List[SchemaOneOfNot]] = Field(default=None, alias="allOf")
    one_of: Optional[List[SchemaOneOfNot]] = Field(default=None, alias="oneOf")
    any_of: Optional[List[SchemaOneOfNot]] = Field(default=None, alias="anyOf")
    items: Optional[SchemaOneOfNot] = None
    properties: Optional[Dict[str, SchemaOneOfNot]] = None
    additional_properties: Optional[SchemaOneOfAdditionalProperties] = Field(default=None, alias="additionalProperties")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['array', 'boolean', 'integer', 'number', 'object', 'string']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exclusiveMaximum": obj.get("exclusiveMaximum") if obj.get("exclusiveMaximum") is not None else False,
            "minimum": obj.get("minimum"),
            "exclusiveMinimum": obj.get("exclusiveMinimum") if obj.get("exclusiveMinimum") is not None else False,
            ...
            "enum": obj.get("enum"),
            "type": obj.get("type"),
            "not": SchemaOneOfNot.from_dict(obj["not"]) if obj.get("not") is not None else None,
            "allOf": [SchemaOneOfNot.from_dict(_item) for _item in obj["allOf"]] if obj.get("allOf") is not None else None,
            "oneOf": [SchemaOneOfNot.from_dict(_item) for _item in obj["oneOf"]] if obj.get("oneOf") is not None else None,
            "anyOf": [SchemaOneOfNot.from_dict(_item) for _item in obj["anyOf"]] if obj.get("anyOf") is not None else None,
            "items": SchemaOneOfNot.from_dict(obj["items"]) if obj.get("items") is not None else None,
            "properties": dict(
                (_k, SchemaOneOfNot.from_dict(_v))
                for _k, _v in obj["properties"].items()
            )
            if obj.get("properties") is not None
            else None,
            "additionalProperties": SchemaOneOfAdditionalProperties.from_dict(obj["additionalProperties"]) if obj.get("additionalProperties") is not None else None,
