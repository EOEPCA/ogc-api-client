...
class TestAdditionalParameterValueInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalParameterValueInner:
        """Test AdditionalParameterValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalParameterValueInner`
        """
        model = AdditionalParameterValueInner()
        if include_optional:
            return AdditionalParameterValueInner(
            )
        else:
            return AdditionalParameterValueInner(
        )
    ...
    def testAdditionalParameterValueInner(self):
        """Test AdditionalParameterValueInner"""
