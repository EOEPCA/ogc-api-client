...
class TestInputDescriptionAllOfMaxOccurs(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InputDescriptionAllOfMaxOccurs:
        """Test InputDescriptionAllOfMaxOccurs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputDescriptionAllOfMaxOccurs`
        """
        model = InputDescriptionAllOfMaxOccurs()
        if include_optional:
            return InputDescriptionAllOfMaxOccurs(
            )
        else:
            return InputDescriptionAllOfMaxOccurs(
        )
    ...
    def testInputDescriptionAllOfMaxOccurs(self):
        """Test InputDescriptionAllOfMaxOccurs"""
