...
class TestInputValueNoObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InputValueNoObject:
        """Test InputValueNoObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputValueNoObject`
        """
        model = InputValueNoObject()
        if include_optional:
            return InputValueNoObject(
                bbox = [
                    1.337
                    ],
    ...
    def testInputValueNoObject(self):
        """Test InputValueNoObject"""
