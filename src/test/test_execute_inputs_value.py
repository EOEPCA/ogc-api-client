...
class TestExecuteInputsValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExecuteInputsValue:
        """Test ExecuteInputsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteInputsValue`
        """
        model = ExecuteInputsValue()
        if include_optional:
            return ExecuteInputsValue(
                bbox = [
                    1.337
                    ],
    ...
    def testExecuteInputsValue(self):
        """Test ExecuteInputsValue"""
