...
class TestSchemaOneOfNot(unittest.TestCase):
    """SchemaOneOfNot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaOneOfNot:
        """Test SchemaOneOfNot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchemaOneOfNot`
        """
        model = SchemaOneOfNot()
        if include_optional:
            return SchemaOneOfNot(
                ref = '',
                title = '',
                multiple_of = 0,
                maximum = 1.337,
