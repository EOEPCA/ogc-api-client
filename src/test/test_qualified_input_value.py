...
class TestQualifiedInputValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QualifiedInputValue:
        """Test QualifiedInputValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QualifiedInputValue`
        """
        model = QualifiedInputValue()
        if include_optional:
            return QualifiedInputValue(
                media_type = '',
                encoding = '',
                var_schema = None,
                value = None
    ...
    def testQualifiedInputValue(self):
        """Test QualifiedInputValue"""
